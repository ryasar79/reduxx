...
The below code shows you how to use the *Object Form* for initial state to set the same initial state as in [Step 1](#step-1-install-reduxx-and-set-your-initial-global-state):
